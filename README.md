...
| **SDKs** | TypeScript: `npm install insightsbyomkar` · Python: `pip install insightsbyomkar` · Go: `go get github.com/omkarjaliparthi/tuffys-astrology-go/tuffys` · all MIT · zero runtime deps |
...
- **[Go SDK](https://github.com/omkarjaliparthi/tuffys-astrology-go)** · [TypeScript SDK (npm)](https://www.npmjs.com/package/insightsbyomkar) · [Python SDK (PyPI)](https://pypi.org/project/insightsbyomkar/)
